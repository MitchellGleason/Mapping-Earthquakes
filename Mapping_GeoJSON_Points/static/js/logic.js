...
let airportData =
	'https://raw.githubusercontent.com/MitchellGleason/Mapping-Earthquakes/main/majorAirports.json';
...
d3.json(airportData).then(function (data) {
	...
	L.geoJSON(data, {onEachFeature: function(feature, layer) {
        console.log(layer);
        layer.bindPopup("<h4>" + "Airport code: " + feature.properties.faa + "</br><hr>Airport name: " + feature.properties.name + "</h3>");
    }}).addTo(map);
});
